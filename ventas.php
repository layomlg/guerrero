...
<html>
  ...
  <body class="body page-index clearfix">
    ...
    */
        ...
        <div class="row">
          <div class="col-sm-3 izq clearfix">
            ...
            <div class="block-cuerpo recursos">
              ...
              <a id="c3"><img src="./Images/svg/pdf.svg"><span>Los secretos y tendencias del canal moderno</span></a>
              <a id="c4"><img src="./Images/svg/pdf.svg"><span>MANUAL- Lideres de Plaza</span></a>
              <a id="c5"><img src="./Images/svg/pdf.svg"><span>ROTACIÓN Y MODELO STAR</span></a>
            </div>

            <p class="block-titulo">Recursos MP4</p>
            <div class="block-cuerpo recursos">
              <a id="c6"><img src="./Images/svg/mp4.svg"><span>El Tiempo-Casa de Papel</span></a>
            </div>
    ...
    <script src="js/cont-ventas.js"></script>
